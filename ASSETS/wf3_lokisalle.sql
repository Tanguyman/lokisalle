...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 20 Juillet 2017 à 11:40
...
--
-- Base de données :  `wf3_lokisalle`
--
CREATE DATABASE IF NOT EXISTS `wf3_lokisalle` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `wf3_lokisalle`;
...
--
ALTER TABLE `commande`
  ADD CONSTRAINT `commande_ibfk_1` FOREIGN KEY (`id_produit`) REFERENCES `produit` (`id_produit`) ON DELETE NO ACTION ON UPDATE CASCADE,
