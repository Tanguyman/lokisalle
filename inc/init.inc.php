...
// connexion à la BDD
$pdo = new PDO('mysql:host=localhost;dbname=wf3_lokisalle', 'root', 'root', array(PDO::ATTR_ERRMODE => PDO::ERRMODE_WARNING, PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES utf8'));
...
// racine site
define("URL", "/php/php_11_lokisalle/"); // modifier le repository chez moi
